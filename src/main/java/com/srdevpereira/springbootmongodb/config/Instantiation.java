...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("21/03/2022"),"Partiu viagem!","Vou viajar para São Paulo. Abraços!", u1);
        Post post2 = new Post(null, sdf.parse("23/03/2023"),"Bom dia!","Acordei feliz hoje!", u1);
